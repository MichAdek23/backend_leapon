  ...
  return (
    <div className='flex items-center justify-center md:justify-between px-1 py-8'>
      ...
      <div className='text-center px-4'>
        ...
        <button onClick={()=> navigate('/SignUp')} className='border font-bold bg-customOrange text-neutral-50 rounded-xl w-[220px] py-3 text-sm flex items-center justify-center'> Get Started </button>
