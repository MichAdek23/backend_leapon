...
const Mentee = () => {
  return (
    <div className='grid grid-cols-1 sm:grid-cols-2 px-10 sm:px-20 gap-32'>
      ...
      <div className='bg-gray-200 w-full border border-r-0 border-b-0 rounded-tl-xl pl-5 pt-5'>
        <div className='bg-white border border-b-0 border-r-0  rounded-tl-xl pl-2 py-2'>
          <div className='bg-white'>
            <img src={asset.mentee2} alt=""  className='w-[62vh] h-[100px] sm:w-[75vh] sm:h-[120px] absolute rounded-l-xl' />
